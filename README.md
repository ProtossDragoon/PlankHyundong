...
|:----------:|:---------------:|:-------------:|
| threshold  | threshold 값이 작으면 파티클의 밀도가 적은 공간에서도 mesh 를 생성합니다.<br>높을수록 용량이 감소합니다. | 50, **✔️ 100** |
| N          | 쉽게 말해 해상도값입니다.<br>높을수록 용량이 증가합니다. | 256, **✔️ 512** |
...
| 5️⃣  | 데이터 정제 + 누끼 제거 | 0.1mm |  20mm/s | 4h  | best |
